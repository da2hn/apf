...
public class HomepageCmSpaceServiceImpl extends EgovAbstractServiceImpl implements HomepageCmSpaceService {
	...
	// 메인화면 센터소식(이미지 목록)
	public List<EgovMap> getCenterNewsImage(CmSpaceVO vo) {
		return homepageCmSpaceMapper.getCenterNewsImage(vo);
	}
	
	// 메인화면 유튜브 목록
	public List<EgovMap> getYoutubeList(CmSpaceVO vo) {
		return homepageCmSpaceMapper.getYoutubeList(vo);
	}
