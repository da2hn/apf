...
public class HomepageMainController {
	...
	public String homepageMainList(CmSpaceVO cmSpaceVO, PopupVO popupVO, ModelMap model, HttpServletRequest request) throws Exception {
		...
		// 센터 목록
		List<EgovMap> centerNewsImage = homepageCmSpaceService.getCenterNewsImage(cmSpaceVO);
		List<EgovMap> youtubeList = homepageCmSpaceService.getYoutubeList(cmSpaceVO);
		...
		model.addAttribute("centerNewsImage",centerNewsImage);
